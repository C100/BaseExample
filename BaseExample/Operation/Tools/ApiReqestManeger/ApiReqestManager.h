 ...
 */
- (void)startWithApi:(__kindof BaseRequestApi * _Nonnull)api completionBlockWithSuccess:(RequestBlock _Nonnull )successBlock  failure:(RequestBlock _Nonnull )failureBlock;
/**
 通过代理方法来调用API
 ...
 */
- (void)chainRequestWithBaseRequset:(BaseRequestApi *_Nonnull)baseApi successThenSecondRequest:(ChainBlock_returnApi _Nonnull )blockthenSecondApi requestFinished:(RequestBlock _Nullable )blockSecond;
/**
 相互依赖的网络请求
 ...
 */
- (void)loadCacheDataWith:(BaseRequestApi * _Nullable)api dataWithCache:(RequestBlock _Nullable )cacheBlock success:(RequestBlock _Nullable )successBlock failure:(RequestBlock _Nullable )failureBlock;
